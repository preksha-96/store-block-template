...
const FooterDesktop: StorefrontFunctionComponent = ({ footerMenu1 }: { footerMenu1: FooterItem }) => {
  ...
  return (
    <div
    >
      <div className="footer b-action-primary c-muted-1  ">
        <div className='row  col-12 contain pa0-s flex justify-between mt4'
        >
          {menu && menu.map((user: FooterItem, index: number) => (
            <div className=" col-md-4 col-lg-4 col-xl-4 col-12">
              <div className='flex justify-between'>
                <h4 key={index} className='ma0'>
      ...
      <div className={`row  col-12 contain w-100-l ${!isMobile ? 'flex justify-between' : 'block'}`}
      >
